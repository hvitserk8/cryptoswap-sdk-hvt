...
describe('Pair', () => {
  const USDC = new Token(ChainId.TESTNET, '0xInsertUSDCAddress', 18, 'USDC', 'USD Coin') // USDC
  const DAI = new Token(ChainId.TESTNET, '0xInsertDAIAddress', 18, 'DAI', 'DAI Stablecoin')
  ...
  describe('#getAddress', () => {
    it('returns the correct address', () => {
      expect(Pair.getAddress(USDC, DAI)).toEqual('0xDAIUSDCPOOLADDRESS') // idk change this 
    })
  })
